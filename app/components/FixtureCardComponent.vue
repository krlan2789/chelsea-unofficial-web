		...
		<div class="card-body items-center text-center gap-4">
			...
			<div class="flex flex-row justify-center items-center gap-2">
				...
				<div class="flex flex-5/12 min-w-28 flex-col w-auto gap-2 justify-start items-center">
					<img class="size-10 aspect-auto"
						:src="'https://media.api-sports.io/football/teams/' + fixture.homeTeamId + '.png'"
						:alt="fixture.homeTeamName" />
					<p class="text-sm h-8 w-auto leading-loose min-w-max" :aria-label="fixture.homeTeamName">{{
						fixture.homeTeamName }}</p>
				</div>
				<!-- Home side -->
				...
				<div class="flex flex-2/12 flex-col min-w-16 max-w-16 gap-2 justify-start items-center">
					<div class="text-2xl h-10 w-full flex flex-row gap-1 justify-center items-center">
						<template v-if="isFixtureDone">
							<p class="grow badge badge-soft badge-neutral badge-xl !p-0 text-2xl">{{
								fixture.homeTeamScore ?? 0 }}</p>
							<p class="grow badge badge-soft badge-neutral badge-xl !p-0 text-2xl">{{
								fixture.awayTeamScore ?? 0 }}</p>
						</template>
						<template v-else>VS</template>
					</div>
					<div class="justify-end w-full h-8">
						<a v-if="isFixtureDone" :href="'/matches/' + fixture.fixtureId"
							class="btn btn-accent h-full w-full leading-40">Statistic</a>
						<template v-else>
				...
				<div class="flex flex-5/12 min-w-28 flex-col w-auto gap-2 justify-start items-center">
					<img class="size-10 aspect-auto"
						:src="'https://media.api-sports.io/football/teams/' + fixture.awayTeamId + '.png'"
